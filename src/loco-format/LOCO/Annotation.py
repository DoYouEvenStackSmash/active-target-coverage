...
def AnnotationAddImageId(builder, imageId): builder.PrependInt32Slot(1, imageId, 0)
def AnnotationAddCategoryId(builder, categoryId): builder.PrependInt32Slot(2, categoryId, 0)
...
class AnnotationT(object):
    ...
    def __init__(self):
        ...
        self.displaced = False  # type: bool
    ...
    def _UnPack(self, annotation):
        ...
        self.displaced = annotation.Displaced()
    ...
    def Pack(self, builder):
        ...
        AnnotationAddDisplaced(builder, self.displaced)
